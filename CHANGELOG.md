...
134. Resume requirement toggle (edit-post-v3) — added "Require resume to request an interview" toggle in the Interview Details section, between slot capacity and Cancel/Update buttons. Uses existing toggle-switch pattern with "Required" (blue) / "Not required" (gray) status label. Summary line updated to show "Resume required" when enabled.
